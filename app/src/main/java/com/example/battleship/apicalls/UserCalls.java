...
public class UserCalls {
    static public void getRooms(String mode, Context context, VolleyCallbackPlayer volleyCallbackPlayer){
        ArrayList<Player> players= new ArrayList();
        RequestQueue queue = Volley.newRequestQueue(context);
        String url ="http://192.168.31.132:8080/api/room";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            JSONArray asD = (JSONArray) jObject.get("rooms");
